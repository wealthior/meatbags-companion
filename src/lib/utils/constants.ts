...
export const MASK_COLOR_CONFIG: Record<MaskColor, MaskColorConfig> = {
  ...
  Black: { color: "Black", dailyYield: 1_250, hexColor: "#2c3e50", rarity: "Uncommon" },
  Burgundy: { color: "Burgundy", dailyYield: 1_275, hexColor: "#800020", rarity: "Uncommon" },
  ...
  Navy: { color: "Navy", dailyYield: 1_375, hexColor: "#1a1a5e", rarity: "Rare" },
  Brown: { color: "Brown", dailyYield: 1_400, hexColor: "#8b4513", rarity: "Rare" },
